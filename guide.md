...
1. PNG \ JPG \ JPEG автоматически конвертируются в webp в `build` при изменении файлов.
В html можно сразу писать `assets/img/name.webp`.
При необходимости доступны ручные `npm run webp` и `npm run imagemin`
